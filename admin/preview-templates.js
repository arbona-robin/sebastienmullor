...
const IndexPreview = ({ entry, widgetFor, getAsset }) => {
  ...
  return h('div', { className: 'page-transition' }, [
    ...
    // Gallery Section
    h('section', { className: 'gallery', id: 'gallery' }, 
  ...
  return h('div', { className: 'architecture-page page-transition' }, [
    ...
    h('section', { className: 'intro-section' }, [
      h('div', { className: 'intro-container' }, [
        ...
        intro.image ? h('div', { className: 'intro-image' }, [
          h('img', { 
    ...
    // Formation Section
    formation.paragraphs ? h('section', { className: 'full-text-section' }, [
    ...
    // Philosophy Section
    philosophy.paragraphs ? h('section', { className: 'full-text-section' }, [
      h('div', { className: 'container' }, [
        h('div', { className: 'text-content' }, [
          h('h2', {}, 'Philosophie'),
    ...
    // Vision Section
    vision.paragraphs ? h('section', { className: 'full-text-section' }, [
      h('div', { className: 'container' }, [
        h('div', { className: 'text-content' }, [
          h('h2', {}, 'Vision'),
      ...
      h('div', { className: 'contact-container' }, [
        ...
        h('div', { className: 'contact-info' }, [
          ...
          h('div', { className: 'contact-details' }, [
            // Address
            address.lines ? h('div', { className: 'contact-item' }, [
              h('h2', {}, 'Adresse'),
              h('p', {}, address.lines.join('\n'))
            ]) : null,
            
            // Phone
            data.phone ? h('div', { className: 'contact-item' }, [
              h('h2', {}, 'Téléphone'),
              h('p', {}, [
            ...
            // Email
            data.email ? h('div', { className: 'contact-item' }, [
              h('h2', {}, 'Email'),
              h('p', {}, [
            ...
            // Website
            website.url ? h('div', { className: 'contact-item' }, [
              h('h2', {}, 'Site Web'),
              h('p', {}, [
                h('a', { 
                  href: website.url,
          ...
          // Projects section
          projects.title ? h('div', { className: 'contact-social' }, [
            h('h2', {}, projects.title),
            h('p', {}, projects.text || '')
          ]) : null
        ]),
        ...
        // Contact Image
        image.path ? h('div', { className: 'contact-image' }, [
          h('img', { 
